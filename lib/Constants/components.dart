  ...
  return Container(
    ...
    child: Stack(
      ...
      children: [
              ...
              children: [
                Expanded(
                    ...
                    child: Center(
                        child:Row(
                          children: [
                            Padding(padding: EdgeInsets.all(8),child: LinkdinSVG(height: 35,width: 35),),
                            Padding(padding: EdgeInsets.all(8),child: googleSVG(),),
        ...
        Positioned(
          top: 80,
          left: MediaQuery.of(context).size.width * 0.5 - 141,
          child: SizedBox(width: 119,child:SvgPicture.string(
                LineLeftSvg,
                allowDrawingOutsideViewBox: true,
                fit: BoxFit.fill,
              ),),),
        Positioned(
          ...
          child:SizedBox(width: 40,child:Text(
            'Or',
            style: TextStyle(
...
Widget googleSVG({double height=40,double width=40,Color bg=Colors.white})
{
  String _gicon_part1 =
...
Widget LinkdinSVG({double height=40,double width=40,Color bg=Colors.white})
{
